            ...
            {orders.map((order) => (
              ...
              >
                <div className="p-4 sm:p-6 border-b border-gray-200">
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                    <div className="flex items-center">
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-sm ${order.status === "paid" ? "bg-green-100 text0green-800" : "bg-gray-100 text-gray-800"}`}
                      >
                        {order.status}
                      </span>
                    </div>
                ...
                <div className="px-4 py-3 sm:px-6 sm:py-4">
                  <p className="text-sm fond-semibold text-gray-600 mb-3 sm:mb-4">
                    Order Items
                  </p>
                  <div className="space-y-3 sm:px-6 sm:py-4">
